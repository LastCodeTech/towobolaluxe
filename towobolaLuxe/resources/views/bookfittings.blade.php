        ...
        <main class="flex-1">
            ...
            <div class="px-6 pb-8">
                <div class="flex flex-col rounded-xl bg-surface-light dark:bg-surface-dark shadow-gentle p-6">
                    <form action="{{ route('bookfittings') }}" method="GET">
                        ...
                        <button class="bg-red-600 text-white p-2 rounded-sm my-2">Find</button>
                    </form>
                </div>
            </div>
            ...
            <div class="px-6 pb-8">
                <div class="flex flex-col rounded-xl bg-surface-light dark:bg-surface-dark shadow-gentle p-6">
                    <label class="flex flex-col w-full">
                        <p class="text-lg font-bold pb-3 text-text-light dark:text-text-dark">Have a particular design
            ...
            <div class="px-6 pb-8">
                <div class="flex flex-col rounded-xl bg-surface-light dark:bg-surface-dark shadow-gentle p-6">
                    <label class="flex flex-col w-full">
                        <p class="text-lg font-bold pb-3 text-text-light dark:text-text-dark">upload a recent picture of
           ...
           @if(!empty($forms))
            ...
            <form action="" method="POST">
             ...
             @else
            {{-- <h3 class="text-center text-lg font-bold leading-tight tracking-[-0.015em] pb-4">oops <a class='text-red-500' href="{{route('contact')}}">contact us</a> regarding the style you want !!!</h3>  --}}
           @endif
            
            <!-- Size Chart Section -->
            <div class="pb-24">
                <h3 class="text-lg font-bold leading-tight tracking-[-0.015em] px-6 pb-4">Size Chart for Fitted Dress
                </h3>
                        ...
                        <div class="overflow-hidden rounded-xl border border-border-light dark:border-border-dark">
                            <table class="min-w-full divide-y divide-border-light dark:divide-border-dark">
                                <thead class="bg-subtle-light dark:bg-subtle-dark">
                                    <tr>
                                        <th class="sticky left-0 bg-subtle-light dark:bg-subtle-dark py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-text-light dark:text-text-dark"
                                            scope="col">Size</th>
                                        <th class="px-3 py-3.5 text-left text-sm font-semibold text-text-light dark:text-text-dark"
                                            scope="col">Bust (cm)</th>
                                        <th class="px-3 py-3.5 text-left text-sm font-semibold text-text-light dark:text-text-dark"
                                            scope="col">Waist (cm)</th>
                                        <th class="px-3 py-3.5 text-left text-sm font-semibold text-text-light dark:text-text-dark"
                                            scope="col">Hips (cm)</th>
                                    </tr>
                                </thead>
                                <tbody
                                    ...
                                    <tr>
                                        <td
                                            class="sticky left-0 bg-surface-light dark:bg-surface-dark whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-text-light dark:text-text-dark">
                                            XS (US 2)</td>
                                        <td
                                            class="whitespace-nowrap px-3 py-4 text-sm text-text-light/80 dark:text-text-dark/80">
                                            82-85</td>
                                        <td
                                            class="whitespace-nowrap px-3 py-4 text-sm text-text-light/80 dark:text-text-dark/80">
                                            63-66</td>
                                    ...
                                    <tr class="bg-background-light dark:bg-background-dark">
                                        <td
                                            class="sticky left-0 bg-background-light dark:bg-background-dark whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-text-light dark:text-text-dark">
                                            S (US 4)</td>
                                        <td
                                            class="whitespace-nowrap px-3 py-4 text-sm text-text-light/80 dark:text-text-dark/80">
                                            86-89</td>
