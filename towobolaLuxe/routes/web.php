...
Route::get('/bookfittings',[TowobolaluxeController::class,'bookfittings'])->name('bookfittings');
// Route::get('/book fittings',[TowobolaluxeController::class,'bookfittings'])->name('bookfittings');
Route::get('/lookBook',[TowobolaluxeController::class,'lookBook'])->name('lookBook');
...
Route::get('/editcollection',[TowobolaluxeController::class,'editcollection'])->name('editcollection');
Route::get('/edittestimonials',[TowobolaluxeController::class,'edittestimonials'])->name('edittestimonials');
...
Route::post('/ContactProcess',[TowobolaluxeController::class,'ContactProcess'])->name('ContactProcess');
